...
class ShoppingListTests(unittest.TestCase):
    ...
    def test_if_list_is_users(self):
        ...
        [{'owner': 'random', 'name': 'List 1', 'description': 'Brief description'}, \
        {'owner': 'random', 'name': 'List 2', 'description': 'Brief description'}, \
        {'owner': 'random2', 'name': 'List 3', 'description': 'Brief description'}]
    ...
    def test_delete_list(self):
        ...
        """
        self.shopping_list_data.shopping_list = \
        [{'owner': 'user1', 'name': 'List 1', 'description': 'Brief description'}, \
        {'owner': 'user1', 'name': 'List 2', 'description': 'Brief description'}, \
        {'owner': 'user1', 'name': 'List 3', 'description': 'Brief description'}]
